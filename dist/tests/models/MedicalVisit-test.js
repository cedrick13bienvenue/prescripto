...
describe('MedicalVisit Model', () => {
    describe('VisitType enum', () => {
        it('should have all required visit types', () => {
            expect(models_1.VisitType.CONSULTATION).toBe('consultation');
            expect(models_1.VisitType.EMERGENCY).toBe('emergency');
            expect(models_1.VisitType.FOLLOWUP).toBe('followup');
        });
        it('should contain all visit type options', () => {
            const visitTypes = Object.values(models_1.VisitType);
    ...
    describe('MedicalVisit attributes', () => {
        it('should have correct default visit type', () => {
            ...
            const visit = new models_1.MedicalVisit({
                id: 'visit-123',
                patientId: 'patient-123',
                doctorId: 'doctor-123',
                visitDate: new Date('2024-12-01'),
                visitType: models_1.VisitType.CONSULTATION,
                chiefComplaint: 'Headache',
            });
            expect(visit.visitType).toBe(models_1.VisitType.CONSULTATION);
        ...
        it('should handle all visit types correctly', () => {
            ...
            const emergencyVisit = {
                visitType: models_1.VisitType.EMERGENCY,
                chiefComplaint: 'Chest pain',
            };
            const followupVisit = {
                visitType: models_1.VisitType.FOLLOWUP,
