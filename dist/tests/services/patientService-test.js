...
const MockPatient = models_1.Patient;
const MockUser = models_1.User;
const MockMedicalVisit = models_1.MedicalVisit;
const MockPrescription = models_1.Prescription;
const MockPrescriptionItem = models_1.PrescriptionItem;
describe('PatientService', () => {
    ...
    describe('registerPatient', () => {
        ...
        it('should successfully register a patient', async () => {
            ...
            const result = await patientService_1.PatientService.registerPatient(mockRegistrationData);
        ...
        it('should handle user creation errors', async () => {
            ...
            await expect(patientService_1.PatientService.registerPatient(mockRegistrationData))
    ...
    describe('getPatientByReference', () => {
        it('should return patient by reference number', async () => {
            ...
            const result = await patientService_1.PatientService.getPatientByReference('PAT-20241201-1234');
        ...
        it('should return null if patient not found', async () => {
            ...
            const result = await patientService_1.PatientService.getPatientByReference('NON-EXISTENT');
        ...
        it('should return null if user is inactive', async () => {
            ...
            MockPatient.findOne.mockResolvedValue(mockPatient);
            const result = await patientService_1.PatientService.getPatientByReference('PAT-123');
            expect(result).toBeNull();
        });
    });
    describe('getPatientById', () => {
        it('should return patient by ID', async () => {
            ...
            const result = await patientService_1.PatientService.getPatientById('patient-123');
        ...
        it('should return null if patient not found', async () => {
            ...
            const result = await patientService_1.PatientService.getPatientById('non-existent');
            expect(result).toBeNull();
        });
    });
    describe('updatePatient', () => {
        it('should successfully update patient profile', async () => {
            ...
            jest.spyOn(patientService_1.PatientService, 'getPatientById').mockResolvedValue(updatedPatient);
            const result = await patientService_1.PatientService.updatePatient('patient-123', updateData);
            expect(mockPatient.update).toHaveBeenCalledWith({ fullName: 'John Updated' });
            expect(MockUser.update).toHaveBeenCalledWith({ phone: '+9999999999' }, { where: { id: 'user-123' } });
            expect(result.fullName).toBe('John Updated');
        });
        it('should throw error if patient not found', async () => {
            MockPatient.findByPk.mockResolvedValue(null);
            await expect(patientService_1.PatientService.updatePatient('non-existent', {}))
    ...
    describe('createMedicalVisit', () => {
        ...
        it('should successfully create medical visit', async () => {
            ...
            const mockDoctor = { id: 'doctor-123', role: models_1.UserRole.DOCTOR };
            const mockVisit = {
                id: 'visit-123',
                ...mockVisitData,
            };
            MockPatient.findByPk.mockResolvedValue(mockPatient);
            MockUser.findOne.mockResolvedValue(mockDoctor);
            MockMedicalVisit.create.mockResolvedValue(mockVisit);
            const result = await patientService_1.PatientService.createMedicalVisit(mockVisitData);
            expect(MockPatient.findByPk).toHaveBeenCalledWith(mockVisitData.patientId);
            expect(MockUser.findOne).toHaveBeenCalledWith({
                where: { id: mockVisitData.doctorId, role: models_1.UserRole.DOCTOR },
            });
        ...
        it('should throw error if patient not found', async () => {
            MockPatient.findByPk.mockResolvedValue(null);
            await expect(patientService_1.PatientService.createMedicalVisit(mockVisitData))
                .rejects.toThrow('Patient not found');
        });
        it('should throw error if doctor not found', async () => {
            MockPatient.findByPk.mockResolvedValue({ id: 'patient-123' });
    ...
    describe('getPatientMedicalHistory', () => {
        it('should return patient medical history', async () => {
            ...
            MockMedicalVisit.findAll.mockResolvedValue(mockVisits);
            MockPrescription.findAll.mockResolvedValue(mockPrescriptions);
            const result = await patientService_1.PatientService.getPatientMedicalHistory('patient-123');
    ...
    describe('createPrescription', () => {
        ...
        it('should successfully create prescription', async () => {
            ...
            MockPatient.findByPk.mockResolvedValue(mockPatient);
            MockUser.findOne.mockResolvedValue(mockDoctor);
            MockMedicalVisit.findByPk.mockResolvedValue(mockVisit);
            MockPrescription.create.mockResolvedValue(mockPrescription);
            MockPrescriptionItem.create.mockResolvedValue({});
            const result = await patientService_1.PatientService.createPrescription(mockPrescriptionData);
            expect(MockPatient.findByPk).toHaveBeenCalledWith(mockPrescriptionData.patientId);
            expect(MockUser.findOne).toHaveBeenCalledWith({
                where: { id: mockPrescriptionData.doctorId, role: models_1.UserRole.DOCTOR },
            });
        ...
        it('should throw error if patient not found', async () => {
            MockPatient.findByPk.mockResolvedValue(null);
            await expect(patientService_1.PatientService.createPrescription(mockPrescriptionData))
                .rejects.toThrow('Patient not found');
        });
        it('should throw error if doctor not found', async () => {
            MockPatient.findByPk.mockResolvedValue({ id: 'patient-123' });
        ...
        it('should throw error if visit not found', async () => {
            MockPatient.findByPk.mockResolvedValue({ id: 'patient-123' });
            MockUser.findOne.mockResolvedValue({ id: 'doctor-123', role: models_1.UserRole.DOCTOR });
    ...
    describe('getPatientPrescriptions', () => {
        it('should return patient prescriptions', async () => {
            ...
            MockPrescription.findAll.mockResolvedValue(mockPrescriptions);
            const result = await patientService_1.PatientService.getPatientPrescriptions('patient-123');
    ...
    describe('searchPatients', () => {
        it('should search patients by name', async () => {
            ...
            MockPatient.findAll.mockResolvedValue(mockPatients);
            const result = await patientService_1.PatientService.searchPatients('John');
        ...
        it('should filter out inactive users', async () => {
            ...
            MockPatient.findAll.mockResolvedValue(mockPatients);
            const result = await patientService_1.PatientService.searchPatients('Patient');
            expect(result).toHaveLength(1);
